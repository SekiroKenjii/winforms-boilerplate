...
/// </summary>
/// <typeparam name="E">The type of exception to be wrapped. Must inherit from <see cref="Exception"/>.</typeparam>
/// <remarks>
...
/// </list>
/// </remarks>
public class Throwable<E> where E : Exception
{
    /// <summary>
    /// Gets or sets the exception that was captured during the execution of a wrapped operation.
    /// </summary>
    /// <value>
    /// The captured exception of type <typeparamref name="E"/>, or null if no exception occurred.
    /// </value>
